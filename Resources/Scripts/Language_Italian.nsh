...
!define RODRILANG ${LANG_ENGLISH}
        ...
        LangString SelectDist_Title         ${RODRILANG} "Selezione Drive e Opzioni Distro Pagina"
        ...
        LangString DrivePage_Text           ${RODRILANG} "Fase 1: Selezionare la lettera di unità del dispositivo USB."
        LangString Distro_Text              ${RODRILANG} "Fase 2: Selezionare una distribuzione dalla lista per mettere sul tuo USB."
        LangString IsoPage_Text             ${RODRILANG} "Fase 3: Selezionare il $FileFormat (nome deve essere lo stesso come sopra)."
        LangString IsoPage_Title            ${RODRILANG} "Seleziona il $FileFormat"
        LangString Casper_Text              ${RODRILANG} "Fase 4: impostare un file di dimensioni persistente per le modifiche memorizzazione (opzionale)."
        ...
        LangString CreateSysConfig          ${RODRILANG} "Creazione di file di configurazione per $DestDisk"
        LangString ExecuteSyslinux          ${RODRILANG} "Esecuzione syslinux su$BootDir"
        LangString SkipSyslinux             ${RODRILANG} "Buona Syslinux esiste ..."
        ...
        LangString Create_Button            ${RODRILANG} "Creare"

        LangString VIEW_ONREM_DISTROS       ${RODRILANG} "Visualizzare o rimuovere distribuzioni installate?"
        LangString DOWNLOAD_ISOOP           ${RODRILANG} "Scarica la ISO (opzionale)."
        LangString SHOW_ALL_ISOS            ${RODRILANG} "Mostra tutte le ISO?"
        LangString RL_BROWSE                ${RODRILANG} "Navigare"
        ...
        LangString SHOW_ALL_DRIVES          ${RODRILANG} "Mostra Tutte le unità?"
        LangString VIEW_OR_REMOVEDISTROS    ${RODRILANG} "Visualizzare o rimuovere distribuzioni installate?"
        LangString VIEW_OR_REMOVEDISTROS2   ${RODRILANG} "Visualizzare o rimuovere distribuzioni installate?"
        ...
        LangString SHOW_ALL_DRIVES2         ${RODRILANG} "Mostra Tutte le unità?"
